...
Info  : https://brightdata.co.kr/products/insights/price-tracker/ozon
"""
...
# https://brightdata.co.kr/products/web-scraper/ozon
DATASET_ID = os.getenv("BRIGHTDATA_DATASET_ID", "")
if not DATASET_ID:
    raise EnvironmentError(
        "BRIGHTDATA_DATASET_ID is not set.\n"
        "1. Build your Ozon scraper at: https://brightdata.co.kr/products/web-scraper/ozon\n"
